...
import { MacroExpectationsPanel } from './MacroExpectations/MacroExpectationsPanel'
...
const DEFAULT_TRAP: StagflationTrap = {
  ...
  inflation_headline: 'Inflation confirmation incomplete',
  inflation_inputs_incomplete: true,
}
...
const DEFAULT_STRESS: SystemicStress = {
  ...
  npl_ratio: undefined, npl_zone: undefined,
  credit_card_chargeoff_rate: undefined, credit_card_chargeoff_zone: undefined,
  market_cap_m2_ratio: undefined, market_cap_m2_zone: undefined, equity_m2_ratio_source: undefined,
  equity_m2_numerator_as_of: undefined, equity_m2_numerator_freshness: undefined,
}
        ...
        {status === 'success' && data && (() => {
          ...
          return (
            <div className="dashboard-grid" style={s.grid}>
              ...
              {data.macro_expectations && (
                <div style={{ gridColumn: '1 / -1' }}>
                  <MacroExpectationsPanel macro={data.macro_expectations} />
                </div>
              )}
              ...
              <div style={{ gridColumn: '1 / -1' }}>
                <FedLiquidityOverviewCard mode={mode} refreshKey={data.generated_at} />
              </div>
